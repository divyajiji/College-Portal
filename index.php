      ...
      <div class="container py-md-3">
        ...
        <div class="calltoaction-20-content row">
          <div class="column center-align-self col-lg-6 pr-lg-5">
            <h5 class="editContent">Welcome</h5>
            <?php
...
<script>
  WebChat.default.init({
    ...
    title: "Counselor AI 🤖",
    subtitle: "Here to help you apply smartly!",
    inputTextFieldHint: "Ask me about admissions...",
    showFullScreenButton: true,
    profileAvatar: "https://i.imgur.com/QrK3K2C.png", 
    openLauncherImage: "https://i.imgur.com/fZ5rEwF.png", 
    params: {
      storage: "session",
    },
  });
