  ...
  <div class="footer-29">
    <div class="container">
      <div class="d-grid grid-col-4 footer-top-29">
        <div class="footer-list-29 footer-1">
          ...
          <ul><?php
              ...
              <li><a href="tel:+91-9795285894"><span class="fa fa-phone"></span> <?php echo $row['MobileNumber']; ?></a></li>
      ...
      <div class="d-grid grid-col-2 bottom-copies">
        <p class="copy-footer-29">Designed & Developed By Cusat Admission Cell</p>
        <br>
        <p class="copy-footer-29">© University Admission Portal. All rights reserved </p>
      </div>
    </div>
  </div>
  <!-- move top -->
