...
<table class="table mb-0">
 <thead>
                <tr>
                  <th>S.NO</th>
                  <th>Course Applied 1</th>
                  <th>Course Applied 2</th>
                  <th>Course Applied 3</th>
                  <th>First Name</th>
                  <th>Last Name</th>
                   <th>Mobile Number</th>
                   <th>Email</th>
...
$ret=mysqli_query($con,"select tbladmapplications.CourseApplied_first, tbladmapplications.CourseApplied_second, tbladmapplications.CourseApplied_third, tbladmapplications.ID as apid, tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Email from  tbladmapplications inner join tbluser on tbluser.ID=tbladmapplications.UserId where tbluser.FirstName like '%$sdata%' || tbluser.MobileNumber like '%$sdata%' || tbluser.Email like '%$sdata%'");
$cnt=1;
