 <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
     ...
     <li class=" nav-item"><a href="#"><i class="la la-file"></i><span class="menu-title" data-i18n="nav.footers.main">Courses</span></a>
        ...
        <li class=" nav-item"><a href="seats.php"><i class="la la-file"></i><span class="menu-title" data-i18n="nav.footers.main">Seats</span></a>
...
<li class=" nav-item"><a href="#"><i class="la la-download"></i><span class="menu-title" data-i18n="nav.footers.main">Enquiry</span></a>
   ...
   <li class=" nav-item"><a href="subscriber.php"><i class="la la-users"></i><span class="menu-title" data-i18n="nav.dash.main">Subscribers</span></a>
        </li>
